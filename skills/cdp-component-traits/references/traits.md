...
- INTERACTION_DRILLABLE：先读 `node_modules/cdp-material-sdk/docs/component-development/recipes/声明层级下钻能力.md`，再查 `node_modules/cdp-material-sdk/docs/component-development/reference/层级下钻能力模型.md`
